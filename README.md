...
| Path | Description |
| --- | --- |
| `gee/sentinel2_osi_cloud_probability_template.js` | Reusable Google Earth Engine Code Editor template |
| `gee/examples/kharg_20260506_example.js` | Kharg Island example for 2026-05-06 |
